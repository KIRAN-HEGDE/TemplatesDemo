		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail Template Demo",
									"targetURL": "#MasterDetailTemplateDemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MasterDetailTemplateDemo-display": {
								"semanticObject": "MasterDetailTemplateDemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterdetaildemo",
									"url": sap.ui.require.toUrl("masterdetaildemo")
								}
							}
						}
					}
